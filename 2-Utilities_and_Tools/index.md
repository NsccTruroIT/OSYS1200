...
1. **Review your device specifications**: processor type and speed, installed RAM, device name, and Windows specifications. **<mark>Take a Screenshot</mark>**
...
1. In the **Apps** section, click **Startup**.
    ...
    - **<mark>Take a Screenshot</mark>** of this list.
...
1. Under **Tablet settings**, find the option **Hide app icons on the taskbar when in tablet mode**.
    - **Turn this off** and **<mark>Take a Screenshot</mark>**.
...
1. Return to the **Settings home page** and explore other available settings.
    ...
    - **<mark>Take a Screenshot</mark>** and **caption it** with a brief description of what it shows and why it interests you.
...
1. Scroll down or look to the right and click **BitLocker Settings**.
    ...
    - **<mark>Take a Screenshot</mark>** of this page.
...
**<mark>Take a Screenshot</mark>** of the Add or Remove Snap-ins window showing the snap-ins you’ve added.

1. Click OK to return to the main MMC window.
    - You should now see your selected snap-ins listed in the left-hand pane.

**<mark>Take a Screenshot</mark>** of the MMC window with your snap-ins visible.
...
3. If your PC **has Bluetooth**:
    ...
    - **<mark>Take a Screenshot</mark>** of this view.
4. **If your PC does not have Bluetooth**☹Optional
    ...
    - **<mark>Take a Screenshot</mark>** of the selected service and its description.
...
1. View Help for ipconfig:
    ...
    - **<mark>Take a Screenshot</mark>** of the Help Output:
...
9. Type `Get-Service w32time | Format-Table Name,DisplayName,Status,StartType` and then press Enter. This displays specific properties in a table format. **<mark>Take a Screenshot</mark>**.
...
15. Read the help information that is displayed for `Restart-Service`. This is only the summary information. **<mark>Take a Screenshot</mark>**.
...
19. Type `Set-ExecutionPolicy RemoteSigned` and then press Enter. This allows you to run any Windows PowerShell scripts that you create but not unsigned scripts from the Internet. **<mark>Take a Screenshot</mark>**.
...
5. Scroll through the list of available features. **<mark>Take a Screenshot</mark>** of this list, then close the Settings window.
6. Click the Start button, type Control Panel, and open it.
7. In Control Panel, click Programs, then click Turn Windows features on or off. **<mark>Take a Screenshot</mark>** of this dialog.
...
12. In PowerShell, type the following command and press Enter:
    ...
    - Review the list and **<mark>Take a Screenshot</mark>**.
...
3. If any devices show a yellow warning icon, **<mark>Take a Screenshot</mark>**.
    - Expand Network adapters, then double-click your network card. **<mark>Take a Screenshot</mark>**
...
7. Click Driver Details. **<mark>Take a Screenshot</mark>** of the list of driver files.
8. Click OK, then go to the Details tab.
9. Use the Property dropdown to browse available properties. **<mark>Take a Screenshot</mark>** of the list.
10. Click the Events tab to view device activity.
    - If available, click the Resources tab to view hardware resource usage. **<mark>Take a Screenshot</mark>**
    - If available, click the Power Management tab to view power settings. **<mark>Take a Screenshot</mark>**
...
9. Click the Settings tab. This shows that if the computer is off when the task is scheduled to run, it will start as soon as possible after the computer is turned on. **<mark>Take a Screenshot</mark>** of this tab.
...
2. Right-click the Start button and click **Computer Management**.
3. In the left pane, click **Task Scheduler**. The middle pane displays the Task Scheduler Summary, showing the status of currently running and previously run tasks. Future scheduled tasks are listed under Active Tasks.
4. In the Actions pane, click **Enable All Tasks History**. This enables logging for troubleshooting. **<mark>Take a Screenshot</mark>**
5. In the left pane, expand **Task Scheduler**, then expand **Task Scheduler Library**, **Microsoft**, **Windows**, and click **Defrag**. **<mark>Take a Screenshot</mark>**
6. In the middle pane, click the **Triggers** tab. Note that the ScheduledDefrag task does not have a schedule because it is triggered by automatic maintenance. **<mark>Take a Screenshot</mark>**
7. Click the **Actions** tab. This shows that the task runs the defrag.exe program.
8. Click the **Conditions** tab. This shows that the task runs only when the computer is on AC power. It stops if the computer switches to battery power.
9. Click the **Settings** tab. This shows that if the computer is off when the task is scheduled to run, it will start as soon as possible after the computer is turned on. **<mark>Take a Screenshot</mark>** of this tab.
10. Click the **History** tab. This displays event log entries for the task, including start and completion times, and any errors. **<mark>Take a Screenshot</mark>**
11. Close the Computer Management window.
...
18. In the Add arguments box, type:
    ...
    - Then click Next.
    - Click Finish.
19. Review the security options. The task will run only when you are signed in. **<mark>Take a Screenshot</mark>**
...
25. Click the History tab and verify that the task ran successfully. **<mark>Take a Screenshot</mark>**.
